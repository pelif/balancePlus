                ...
                <div className="text-green-400 text-2xl font-bold flex items-center">
                    <a href="/" className="flex items-center">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <rect x="1" y="1" width="10" height="10" fill="#34D399"/>
                            <rect x="13" y="1" width="10" height="10" fill="#34D399"/>
                            <rect x="7" y="7" width="10" height="10" fill="#34D399"/>
                            <rect x="1" y="13" width="10" height="10" fill="#34D399"/>
                            <rect x="13" y="13" width="10" height="10" fill="#34D399"/>
                        </svg>
                        <span className="ml-2">BalancePlus</span>
                    </a>
                </div>
